...
var file_proto_proto_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x32, 0xc8, 0x02, 0x0a, 0x0c, 0x4c, 0x69, 0x62, 0x72,
...
var file_proto_proto_proto_depIdxs = []int32{
	...
	4, // 7: proto.LibroService.uploadBook:output_type -> proto.replyEmpty
	6, // 8: proto.LibroService.getAddressChunks:output_type -> proto.sendUbicacion
	3, // 9: proto.LibroService.downloadChunk:output_type -> proto.sendChunk
	1, // 10: proto.LibroService.sendPropuesta:output_type -> proto.Propuesta
	4, // 11: proto.LibroService.OrdenarChunk:output_type -> proto.replyEmpty
	0, // 12: proto.LibroService.verStatus:output_type -> proto.Status
